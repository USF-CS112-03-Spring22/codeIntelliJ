...
public class JsonProcessing {
    public static void main(String[] args) {
        parseSimple("src/main/java/lecture21Json/fruit.json");
        parsePersonInfo("src/main/java/jsonFiles/exJsonPersonInfo.json");

        // jsonParserExample("src/main/java/jsonFiles/people.json");
        // parsePeople("src/main/java/jsonFiles/exJsonPeople.json");
        // parseJSONObjectWithArray("src/main/java/jsonFiles/exJsonWithArray.json");
    }
     ...
     */
    public static void parseSimple(String filePath) {
        Gson gson = new Gson();
    ...
    public static void jsonParserExample(String filePath) {
        Gson gson = new Gson();
        try {
     ...
     * @param filePath path to the json file
     */
    public static void parsePeople(String filePath) {
        Gson gson = new Gson();
     ...
     * @param filePath
     */
    public static void parseJSONObjectWithArray(String filePath) {
        try (JsonReader jsonReader = new JsonReader(new FileReader(filePath))) {
            jsonReader.beginObject();
