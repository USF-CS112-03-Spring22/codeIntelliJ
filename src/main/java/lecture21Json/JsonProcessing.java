...
public class JsonProcessing {
    public static void main(String[] args) {
        parseFruitFile("src/main/java/lecture21Json/fruit.json");
        // parsePersonInfo("src/main/java/lecture21Json/personInfo.json");
        // parsePeopleArray("src/main/java/lecture21Json/people.json");
    }
